...
public class AdminServiceControllerTest {
	...
	public void getAllEmployeesAPI() throws Exception {
		mvc.perform(MockMvcRequestBuilders.get("/viewcustomers").accept(MediaType.APPLICATION_JSON))
	...
	public void getEmployeeByIdAPI() throws Exception {
		mvc.perform(MockMvcRequestBuilders.get("/customerbyid/{id}", 1).accept(MediaType.APPLICATION_JSON))
				.andDo(MockMvcResultHandlers.print()).andExpect(MockMvcResultMatchers.status().isOk())
	...
	public void createEmployeeAPI() throws Exception {
		...
		mvc.perform(MockMvcRequestBuilders.post("/AddCustomer").content(asJsonString(cc))
