    ...
    <div class="row">
            ...
            <div class="sign-grds">
                <div class="col-md-3 sign-gd-two">
                    ...
                    <ul style="text-align: left;">
                        ...
                        <li><i class="glyphicon glyphicon-envelope" aria-hidden="true"></i>Email : <a href="mailto:info@revshop.training">info@revshop.training</a></li>
        ...
        <div class="col">
            ...
            <center>
                <div class="container">
                    <h4>
                        &copy;  <span id="year"></span> RevShop - Online Shopping System |<a href="https://Rev-shop.training" target="_blank"> Designed by : RevShop</a>
                    </h4>
                </div>
            </center>
        </div>
