                ...
                <form action="GetProductsOrder" method="post">
                    ...
                    <div>
                        ...
                        <div class="form-group">
                            ...
                            <script src="https://checkout.razorpay.com/v1/payment-button.js" data-payment_button_id="pl_P6C9prLtlRt6EX" async> </script>
                        </div>
                        <div>
                            <%
                            ...
                            <input type="submit" value="confirm order" class="btn btn-success" onclick="return confirm('Are you sure Do you want to buy this order?');">
