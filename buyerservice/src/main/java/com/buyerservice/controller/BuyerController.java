...
public class BuyerController {
	...
	public int updateProductQuantity(@PathVariable("quantity") int quantity, @PathVariable("productId") int productId,
	...
	public List<Object> findTotalProduct(@PathVariable("cid") Object customerid,
			@PathVariable("orderid") int order_no) {
